...
// ECDHE_RSA cipher suites (same encryption, RSA authentication)
#[derive(Debug)]
struct EcdheRsaAes128GcmSha256;

impl SupportedDtls12CipherSuite for EcdheRsaAes128GcmSha256 {
    fn suite(&self) -> Dtls12CipherSuite {
...
#[derive(Debug)]
struct EcdheRsaAes256GcmSha384;

impl SupportedDtls12CipherSuite for EcdheRsaAes256GcmSha384 {
    fn suite(&self) -> Dtls12CipherSuite {
...
#[derive(Debug)]
struct EcdheRsaChaCha20Poly1305Sha256;

impl SupportedDtls12CipherSuite for EcdheRsaChaCha20Poly1305Sha256 {
    fn suite(&self) -> Dtls12CipherSuite {
...
static ECDHE_RSA_AES_128_GCM_SHA256: EcdheRsaAes128GcmSha256 = EcdheRsaAes128GcmSha256;
static ECDHE_RSA_AES_256_GCM_SHA384: EcdheRsaAes256GcmSha384 = EcdheRsaAes256GcmSha384;
static ECDHE_RSA_CHACHA20_POLY1305_SHA256: EcdheRsaChaCha20Poly1305Sha256 = EcdheRsaChaCha20Poly1305Sha256;
