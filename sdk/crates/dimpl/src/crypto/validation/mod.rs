        ...
        for cs in self.supported_cipher_suites() {
            ...
            let (cert_der, signature, test_data) = match (hash_alg, sig_alg) {
                ...
                (HashAlgorithm::SHA256, SignatureAlgorithm::RSA) => (
                    VALIDATION_RSA2048_CERT,
                    VALIDATION_RSA2048_SHA256_SIG,
                    VALIDATION_TEST_DATA,
                ),
                (HashAlgorithm::SHA384, SignatureAlgorithm::RSA) => (
                    VALIDATION_RSA2048_CERT,
                    VALIDATION_RSA2048_SHA384_SIG,
                    VALIDATION_TEST_DATA,
                ),
                _ => {
                    return Err(Error::ConfigError(format!(
...
const VALIDATION_RSA2048_CERT: &[u8] = include_bytes!("rsa2048_cert.der");
const VALIDATION_RSA2048_SHA256_SIG: &[u8] = include_bytes!("rsa2048_sha256_sig.bin");
const VALIDATION_RSA2048_SHA384_SIG: &[u8] = include_bytes!("rsa2048_sha384_sig.bin");
...
mod tests_aws_lc_rs {
    ...
    fn test_default_provider_has_cipher_suites() {
        ...
        // ECDHE ECDSA: AES-128, AES-256, ChaCha20
        // ECDHE RSA: AES-128, AES-256, ChaCha20
        // PSK: CCM-8
        assert_eq!(count, 7);
    }
