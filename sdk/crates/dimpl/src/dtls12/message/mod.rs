...
pub enum Dtls12CipherSuite {
    ...
    /// ECDHE with RSA authentication, ChaCha20-Poly1305, SHA-256
...
impl Dtls12CipherSuite {
    ...
    pub fn from_u16(value: u16) -> Self {
        match value {
            ...
            // ECDHE with AES-GCM (RSA)
            0xC02F => Dtls12CipherSuite::ECDHE_RSA_AES128_GCM_SHA256,
            0xC030 => Dtls12CipherSuite::ECDHE_RSA_AES256_GCM_SHA384,
            0xCCA8 => Dtls12CipherSuite::ECDHE_RSA_CHACHA20_POLY1305_SHA256,
    ...
    pub fn as_u16(&self) -> u16 {
        match self {
            ...
            // ECDHE with AES-GCM (RSA)
            Dtls12CipherSuite::ECDHE_RSA_AES128_GCM_SHA256 => 0xC02F,
            Dtls12CipherSuite::ECDHE_RSA_AES256_GCM_SHA384 => 0xC030,
            Dtls12CipherSuite::ECDHE_RSA_CHACHA20_POLY1305_SHA256 => 0xCCA8,
    ...
    pub fn verify_data_length(&self) -> usize {
        match self {
            ...
            | Dtls12CipherSuite::ECDHE_RSA_AES128_GCM_SHA256
            | Dtls12CipherSuite::ECDHE_RSA_AES256_GCM_SHA384
            | Dtls12CipherSuite::ECDHE_RSA_CHACHA20_POLY1305_SHA256
            | Dtls12CipherSuite::PSK_AES128_CCM_8 => 12,

            Dtls12CipherSuite::Unknown(_) => 12,
        }
    }
    ...
    pub const fn all() -> &'static [Dtls12CipherSuite; 7] {
        &[
            Dtls12CipherSuite::ECDHE_ECDSA_AES256_GCM_SHA384,
            Dtls12CipherSuite::ECDHE_ECDSA_AES128_GCM_SHA256,
            Dtls12CipherSuite::ECDHE_ECDSA_CHACHA20_POLY1305_SHA256,
    ...
    pub fn hash_algorithm(&self) -> HashAlgorithm {
        match self {
            Dtls12CipherSuite::ECDHE_ECDSA_AES256_GCM_SHA384
            | Dtls12CipherSuite::ECDHE_RSA_AES256_GCM_SHA384 => HashAlgorithm::SHA384,
            Dtls12CipherSuite::ECDHE_ECDSA_AES128_GCM_SHA256
            | Dtls12CipherSuite::ECDHE_ECDSA_CHACHA20_POLY1305_SHA256
            | Dtls12CipherSuite::ECDHE_RSA_AES128_GCM_SHA256
            | Dtls12CipherSuite::ECDHE_RSA_CHACHA20_POLY1305_SHA256
    ...
    pub const fn supported() -> &'static [Dtls12CipherSuite; 7] {
        Self::all()
    }
}
